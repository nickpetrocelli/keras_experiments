# Second iteration of a net designed to classify images according to the CIFAR-10 dataset.
# This is improved by including additional convolutional steps before each pooling step.
